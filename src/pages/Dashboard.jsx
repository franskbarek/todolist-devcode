...
export default function DashboardEmpty() {
  ...
  return (
    <div data-cy="activity-empty-state" className="flex flex-col items-center justify-center">
      ...
      {lists?.length < 1 && <img data-cy="activity-empty-state" className="absolute w-1/8 left-[337px] top-[255px] z-10" src={bannerEmptyActivity} alt="emptystate" />}
      ...
      <div className="flex flex-row justify-center items-center pt-[13px] pr-[21px] pb-[13px] pl-[14px]  gap-1.5" onClick={handleCreateActivity} data-cy="activity-add-button">
        <button data-cy="activity-add-button" className="absolute bg-primary-500 w-[159px] h-[54px] left-[1150px] top-[154px] rounded-full">
          <div className="flex justify-center items-center">
            ...
            {addLoading ? <CircularProgress size={30} color="inherit" /> : <p className="font-poppins text-white not-italic font-semibold text-lg">Tambah</p>}
          </div>
        </button>
      </div>
      ...
      <div data-cy="activity-item" className="flex justify-center items-center flex-wrap mx-auto w-5/6 mt-[150px]">
